...
function SpotlightLevel()
{
    ...
    this.mTrackedLight.setColor([.7, 1, 1, 1]);
    this.mTrackedLight.set2DPosition([150, 105]);
    this.mTrackedLight.setZPos(200);
    this.mTrackedLight.setDirection(vec3.fromValues(0, 0, -1));
    this.mTrackedLight.setLightType(Light.eLightType.eSpotLight);
    this.mTrackedLight.setNear(100);
    this.mTrackedLight.setFar(350);
    this.mTrackedLight.setDropOff(1);
    this.mTrackedLight.setIntensity(7);
...
gEngine.Core.inheritPrototype(SpotlightLevel, Level);

SpotlightLevel.prototype.update = function()
{
