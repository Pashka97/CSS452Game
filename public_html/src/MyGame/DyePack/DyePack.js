...
/*global gEngine, GameObject, SpriteRenderable, vec2, NonPhysicsGameObject */
...
function DyePack(spriteTexture, x, y) {
    ...
    NonPhysicsGameObject.call(this, this.mDyePack);
...
gEngine.Core.inheritPrototype(DyePack, NonPhysicsGameObject);
